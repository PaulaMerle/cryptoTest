{
  mode: 'production',
  context: 'C:\\Dev\\cryptoApp\\crypto-front',
  devtool: 'source-map',
  node: {
    setImmediate: false,
    process: 'mock',
  ...
  output: {
    path: 'C:\\Dev\\cryptoApp\\crypto-front\\target\\dist',
  ...
  resolve: {
    alias: {
      '@': 'C:\\Dev\\cryptoApp\\crypto-front\\src',
    ...
    rules: [
      /* config.module.rule('vue') */
      {
        ...
        use: [
          ...
          {
            loader: 'C:\\Dev\\cryptoApp\\crypto-front\\node_modules\\cache-loader\\dist\\cjs.js',
            options: {
              cacheDirectory: 'C:\\Dev\\cryptoApp\\crypto-front\\node_modules\\.cache\\vue-loader',
              cacheIdentifier: '67e904ac'
            }
          },
        ...
        use: [
          /* config.module.rule('eslint').use('eslint-loader') */
          {
            ...
            options: {
              ...
              cache: true,
              cacheIdentifier: '5eba5a11',
              emitWarning: false,
              emitError: false,
              eslintPath: 'C:\\Dev\\cryptoApp\\crypto-front\\node_modules\\eslint',
              formatter: undefined
            }
          }
        ]
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin(
      {
        ...
        template: 'C:\\Dev\\cryptoApp\\crypto-front\\public\\index.html'
      }
    ),
    ...
    new CopyPlugin(
      [
        {
          from: 'C:\\Dev\\cryptoApp\\crypto-front\\public',
          to: 'C:\\Dev\\cryptoApp\\crypto-front\\target\\dist',
          toType: 'dir',
          ignore: [
            '.DS_Store',
            {
